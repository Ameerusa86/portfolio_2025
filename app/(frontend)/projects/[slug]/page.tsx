          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap justify-center gap-8 pt-6">
              <div className="text-center">
                <div className="text-2xl font-bold text-primary">{project.tech_stack?.length || 0}</div>
                <div className="text-sm text-muted-foreground">Technologies</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-primary">{formatDate(project.created_at).split(',')[1]}</div>
                <div className="text-sm text-muted-foreground">Year</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-primary">{project.published ? "Live" : "Dev"}</div>
            ...
            <Card className="overflow-hidden border-0 shadow-2xl bg-white/80 backdrop-blur-sm">
              <CardContent className="p-0">
                <div className="relative aspect-video lg:aspect-[21/9] w-full">
                  <Image
                    src={getProjectImageUrl(project.image) || "/placeholder-project.jpg"}
                    alt={project.title}
                    fill
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <Card className="p-6 border border-primary/20 bg-gradient-to-br from-white to-primary/5 hover:shadow-lg transition-all duration-300">
                    <CardContent className="space-y-4">
                      ...
                      <p className="text-muted-foreground text-sm">
                        Optimized for speed and performance with modern development techniques.
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="p-6 border border-primary/20 bg-gradient-to-br from-white to-primary/5 hover:shadow-lg transition-all duration-300">
                    <CardContent className="space-y-4">
                      ...
                      <p className="text-muted-foreground text-sm">
                        Intuitive and user-friendly interface designed with accessibility in mind.
                      </p>
                    </CardContent>
                  </Card>
                </div>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      ...
                      <Badge variant={project.published ? "default" : "secondary"} className="font-medium">
                        {project.published ? "Live & Active" : "In Development"}
                      </Badge>
                    </div>
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-sm font-medium">{project.tech_stack?.length || 0} Stack</span>
                    </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <Button 
                      ...
                      onClick={() => {
                        ...
                        a.href = url;
                        a.download = `${project.title.replace(/\s+/g, '_')}_info.txt`;
          ...
          <div className="text-center bg-white/80 backdrop-blur-sm rounded-3xl p-12 lg:p-20 shadow-xl border border-white/50">
            <div className="space-y-6">
              ...
              <p className="text-muted-foreground text-lg lg:text-xl max-w-2xl mx-auto leading-relaxed">
                Let's collaborate and bring your vision to life with the same attention to detail, 
                quality, and passion that went into this project.
              </p>
