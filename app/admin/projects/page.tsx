    ...
    <div className="min-h-screen bg-background text-foreground w-full">
      <div className="w-full site-container py-8 space-y-8 max-w-none">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-card/70 border border-border rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02] group">
            <div className="flex items-center justify-between">
              ...
              <div className="h-14 w-14 bg-accent/30 rounded-2xl flex items-center justify-center shadow-md group-hover:shadow-lg transition-all duration-300">
                <svg
