  ...
  ({ label, className = "", ...props }, ref) => {
    return (
      <label className={`flex items-center gap-2 cursor-pointer ${className}`}>
        <input
          type="checkbox"
          className="peer appearance-none w-10 h-6 bg-border/60 rounded-full checked:bg-primary transition-colors relative outline-none focus:ring-2 focus:ring-primary/30"
          ref={ref}
          {...props}
        />
